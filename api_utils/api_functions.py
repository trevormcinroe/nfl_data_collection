"""
The raw data returned here is twofold:
    (1): Player JSON
    (2): Stats JSON

(1) Is small and contains the biometric data on the player, as well as what team they are currently
playing on as well as their position on said team

(2) Is much larger, in the form of a list of dictionaries, where each dictionary is a game that
the player has played
    [{playerid, year, gameid, ...}, ...]
"""
...
if __name__ == '__main__':
    ...
    nfl_scraper = Scraper(letters_to_scrape=letters_to_scrape,
                          num_jobs=10,
